...
public class MonthEventsAdapter extends ArrayAdapter<String>{
	...
	private final ArrayList<OctoberEvents> items;
	public MonthEventsAdapter(Context context, ArrayList<OctoberEvents> items) {
...
public View getView(int position, View convertView, ViewGroup parent){
	...
	if(convertView!=null){
		...
		rowView = inflater.inflate(R.layout.month_events_list, parent, false);
	}
